...
const tmpRoot = mkdtempSync(join(tmpdir(), "wakaru-parameters-"));
const toolRoot = join(repoRoot, "target", "repro-tools", "parameters");
...
try {
  console.log("# Parameters reproduction matrix");
...
const result = babel.transformSync(source, config);
