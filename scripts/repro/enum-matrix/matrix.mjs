...
const tmpRoot = mkdtempSync(join(tmpdir(), "wakaru-enum-"));
const toolRoot = join(repoRoot, "target", "repro-tools", "enum");
...
const babelProfiles = [
  ...
  },
  {
    name: "babel-8-rc",
    core: "8.0.0-rc.5",
    plugin: ["@babel/plugin-transform-typescript", "8.0.0-rc.5"],
    modes: ["standard", "optimizeConstEnums"],
  },
];
...
try {
  console.log("# Enum reproduction matrix");
...
function runBabel(source, profile, pluginOptions) {
...
const transformTypescript = pluginModule.default ?? pluginModule;
...
const result = babel.transformSync(source, {
  ...
  comments: false,
  compact: false,
  plugins: [[transformTypescript, pluginOptions]],
});
