(() => {
  ...
  console.log(greet("world"), add(1, PI), (0, import_utils_cjs.clamp)(5, 0, 10), (0, import_format_cjs.padLeft)("x", 5), (0, import_validate_cjs.isEmail)("a@b"), (0, import_convert_cjs.toUpper)("hi"), (0, import_array_cjs.unique)([1, 2, 2]));
})();
