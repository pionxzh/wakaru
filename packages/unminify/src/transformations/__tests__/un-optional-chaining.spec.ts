...
inlineTest('Babel - Member access',
  `
...
inlineTest('Babel - In method key',
  `
var _x$y;
let x;
const a = {
...
inlineTest('Babel - In var destructuring',
  `
var _x;
var {
 ...
 * foo?.bar?.(foo?.bar)
 */
inlineTest('Babel - Memoize with assumption pureGetter',
  `
function test(foo) {
...
inlineTest('Babel - Optional eval call',
  `
