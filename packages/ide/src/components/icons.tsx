...
function IconWrapper({ className, ...props }: ComponentProps<'svg'>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
            className={cn('inline w-4 h-4 mr-2', className)}
            {...props}
        />
    )
}

export function IconJavascript(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 482.2 367.2" {...props}>
            <path
...
export function IconTypescript(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 24.94 16.43" {...props}>
            <path
...
export function IconHtml(props: ComponentProps<'svg'>) {
    return (
...
export function CssIcon(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 256 232" {...props}>
            <path
...
export function IconReact(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 490.6 436.9" {...props}>
            <g fill="#61dafb">
...
export function IconNpm(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 256 100" {...props}>
            <path
...
export function IconFolder(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 260.73 208.59" {...props}>
            <path
                d="M104.29 0H26.07A26 26 0 00.13 26.07L0 182.51a26.06 26.06 0 0026.07 26.07h208.59a26.06 26.06 0 0026.07-26.07V47a26.07 26.07 0 00-26.07-26.07H130.37C131.1 20.91 104.57 0 104.29 0z"
                fill="#42a5f5"
            />
        </IconWrapper>
    )
...
export function IconFolderOpen(props: ComponentProps<'svg'>) {
    return (
        <IconWrapper viewBox="0 0 260.93 208.43" {...props}>
            <path
