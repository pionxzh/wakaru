...
class Logger {
  ...
  debug(msg, ...args) {
    if (this._level <= LogLevel.DEBUG)
      console.debug(this._format(LogLevel.DEBUG, msg), ...args);
  }
  info(msg, ...args) {
    if (this._level <= LogLevel.INFO)
      console.info(this._format(LogLevel.INFO, msg), ...args);
  }
  warn(msg, ...args) {
    if (this._level <= LogLevel.WARN)
      console.warn(this._format(LogLevel.WARN, msg), ...args);
  }
  error(msg, ...args) {
    if (this._level <= LogLevel.ERROR)
      console.error(this._format(LogLevel.ERROR, msg), ...args);
  }
  child(prefix) {
