...
import sibling from "./module-44675.js";
const siblingCjs = require("./module-44675.js");
const literal = 'require("./module-44675.js")';
// from "./module-44675.js";
...
"#
        ...
        assert!(
            modules[1].code.contains(r#"from "../module-44675.js""#),
            "child imports of external sibling modules should point out of the child dir:\n{}",
            modules[1].code
        );
        assert!(
            modules[1].code.contains(r#"require("../module-44675.js")"#),
        ...
        assert!(
            modules[1]
                .code
                .contains(r#"const literal = 'require("./module-44675.js")';"#),
        ...
        let mut available: HashSet<String> = modules
            ...
            .map(|module| module.filename.clone())
            .collect();
        available.insert("module-44675.js".to_string());
    ...
    fn numeric_rewrite_paths_are_relative_to_nested_module() {
        ...
        assert_eq!(
            relative_import_specifier("module-3276.js", "module-3276/chunk_value.js"),
            "./module-3276/chunk_value.js"
        );
        assert_eq!(
            relative_import_specifier("module-15300/chunk_dr.js", "module-44675.js"),
            "../module-44675.js"
        );
        assert_eq!(
            relative_import_specifier("module-15300/chunk_dr.js", "module-15300/chunk_tO.js"),
            "./chunk_tO.js"
        );
        assert_eq!(
            relative_import_specifier("module-15300/chunk_dr.js", "module-24274/chunk_td.js"),
            "../module-24274/chunk_td.js"
        );
    }
