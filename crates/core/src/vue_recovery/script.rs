...
use super::{
    ...
    setup_local_declarations, setup_prop_bindings, setup_props_script_binding,
    setup_ref_declarations, RenderSource, VueNode, VueRecoveryContext, VueScriptImport,
    VueScriptSetupDeclaration, VueSetupLocalBinding, VueTemplateUsage,
};
