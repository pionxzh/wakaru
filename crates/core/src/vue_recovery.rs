...
use swc_core::ecma::ast::{
    ...
    FnDecl, Lit, Module, ModuleDecl, ModuleItem, ObjectLit, ReturnStmt, Stmt,
};
...
use attrs::{recover_attrs, recover_component_attrs};
use context::{collect_context, collect_render_context, render_context_param};
use directives::recover_directive_tuple;
use expressions::{clean_attr_expr, clean_expr, print_expr, printed_vue_expr, raw_expr};
use helpers::{helper_name, is_fragment_tag, VueHelper};
use syntax::{pat_binding_ident, string_lit, wtf8_to_string};
